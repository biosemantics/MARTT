...
/**
 * not used as a class. see PRSScore for implementation of score simScore.
 * 
 */
public class SimScore extends Score {
	private float sim = 0;
	...
	public Score score(ElementComponent ec) {
		...
		sim = wbcs.compute(learning.Utilities.removeTaxon(ansxml),
				learning.Utilities.removeTaxon(markedsxml));
		return this;
	}
