...
* * This program is free software; you can redistribute it and/or
 ...
 public final class MathFunctions {
  ...
  public static void main(String[] args) {
    MathFunctions functions1 = new MathFunctions();
    System.out.println((int)Math.ceil(nCr(15, 1)));
    System.out.println((int)Math.ceil(nCr(15, 2)));
    System.out.println((int)Math.ceil(nCr(15, 3)));
    System.out.println((int)Math.ceil(nCr(15, 4)));
    System.out.println((int)Math.ceil(nCr(15, 5)));
    System.out.println((int)Math.ceil(nCr(15, 6)));
    System.out.println((int)Math.ceil(nCr(15, 7)));
    System.out.println((int)Math.ceil(nCr(15, 8)));
    System.out.println((int)Math.ceil(nCr(15, 9)));
    System.out.println((int)Math.ceil(nCr(15, 10)));
    System.out.println((int)Math.ceil(nCr(15, 11)));
    System.out.println((int)Math.ceil(nCr(15, 12)));
    System.out.println((int)Math.ceil(nCr(15, 13)));
    System.out.println((int)Math.ceil(nCr(15, 14)));
    System.out.println((int)Math.ceil(nCr(15, 15)));
