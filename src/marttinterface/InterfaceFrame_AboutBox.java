...
public class InterfaceFrame_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "User Interface of MARTT ";
  String version = "1.0";
  String copyright = "Copyright (c) 2005";
  String comments = "Support training example annotation and marked-up example review.";
  ...
  private void jbInit() throws Exception  {
    image1 = new ImageIcon(marttinterface.InterfaceFrame.class.getResource("about.png"));
